...
CREATE TABLE `accomodation` (
  ...
  `accomodation_image_id` varchar(45) DEFAULT NULL,
  `category` varchar(45) NOT NULL,
  `accomodation_description` varchar(200) DEFAULT NULL,
...
INSERT INTO `accomodation` VALUES (7,'hotel','6860','hotel','6','no ','123','0000-00-00 00:00:00',1,2),(8,'1','1723','1','1111111234555','1','1','0000-00-00 00:00:00',2,2),(9,'31231','117','3123','3123','3123','3123','2014-09-07 12:53:11',1,2),(10,'1','4649','1','1','1','1','2014-09-07 14:50:13',5,2),(11,'1','1433','2','2','2','2','2014-09-09 16:48:15',1,2),(12,'4','1980','4','4','4','4','2014-09-09 16:48:28',1,2);
...
INSERT INTO `booking` VALUES (1,'0000-00-00',0,'2014-09-04 13:49:21',1,3,1,2),(2,'0000-00-00',0,'2014-09-04 13:50:05',1,3,2,2),(3,'0000-00-00',0,'2014-09-04 13:50:26',1,3,2,2),(4,'0000-00-00',0,'2014-09-04 13:54:50',1,3,2,2),(5,'0000-00-00',0,'2014-09-04 13:56:13',1,3,2,2),(6,'2014-09-09',0,'2014-09-04 13:56:20',1,3,1,2),(7,'2014-09-16',5,'2014-09-04 13:59:04',1,3,2,2),(9,'2014-09-01',5,'2014-09-05 08:36:59',1,3,1,2),(10,'2014-09-01',5,'2014-09-05 08:43:34',1,3,4,2),(11,'2014-09-08',5,'2014-09-05 09:06:37',1,3,2,2),(12,'2014-09-01',5,'2014-09-05 09:32:56',1,3,2,2),(13,'2014-09-02',5,'2014-09-05 09:35:54',1,3,2,2),(15,'2014-09-16',5,'2014-09-07 06:17:44',1,3,1,2),(16,'2014-09-15',50,'2014-09-08 08:44:39',2,3,4,2),(17,'2014-09-08',5,'2014-09-08 09:43:29',1,3,4,2),(18,'2014-09-09',5,'2014-09-09 13:38:45',1,3,4,1),(19,'2014-09-09',5,'2014-09-09 13:39:47',1,3,4,1);
...
CREATE TABLE `package` (
  ...
  `package_image_id` varchar(45) DEFAULT NULL,
...
INSERT INTO `package` VALUES (1,'1234','1234','1234','7218','1234','2014-09-02 05:44:52',5,5,7,2,1),(2,'4234234','4234234','50','5111','423423','2014-09-06 10:23:41',1,5,7,2,1),(3,'123','1','1','6172','1','2014-09-07 09:48:34',1,5,7,2,2),(4,'','','','6324','','2014-09-08 03:09:29',1,5,7,2,1),(5,'','','','1708','','2014-09-08 03:11:42',1,5,7,2,1),(6,'3123','3123','5','3631','3123456789','2014-09-09 16:06:18',1,5,7,2,1),(7,'3123','3123','5','2036','3123321123','2014-09-09 16:06:38',1,5,7,2,1),(8,'3123','3123','5','7708','3123321456','2014-09-09 16:07:04',1,5,7,2,1),(9,'3123','3123','5','7962','3123111111','2014-09-09 16:07:14',1,5,7,2,1),(10,'555','555','5555','1067','5555','2014-09-09 16:10:46',3,5,7,2,1);
...
CREATE TABLE `payment` (
  ...
  KEY `fk_payment_package1_idx` (`package_id`),
  ...
  CONSTRAINT `fk_payment_package1` FOREIGN KEY (`package_id`) REFERENCES `package` (`package_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `payment` VALUES (1,'3123','cash','2014-09-05 08:43:34',2,3,10,2,4),(3,'4234234','cash','2014-09-06 10:20:26',2,3,10,2,4),(5,'31233','cash','2014-09-07 06:17:44',2,4,15,2,5),(6,'4234234','cash','2014-09-08 08:44:39',2,3,16,2,5),(7,'31233','cash','2014-09-08 09:43:29',1,3,17,2,5),(8,'3123','cash','2014-09-09 13:38:45',1,3,18,1,4),(9,'3123','cash','2014-09-09 13:39:47',1,3,19,1,4);
...
INSERT INTO `review` VALUES (3,'54321','2014-09-08 09:40:35',3,1),(4,'321654','2014-09-08 15:15:39',3,1),(5,'321123','2014-09-08 15:21:52',3,1),(7,'3215654','2014-09-08 15:46:47',3,1);
...
INSERT INTO `status` VALUES (1,'active'),(2,'deactive'),(3,'pending'),(4,'cancel'),(5,'success');
...
CREATE TABLE `transport` (
  ...
  `transport_image_id` varchar(45) DEFAULT NULL,
...
INSERT INTO `transport` VALUES (5,'1','1','1027','1','1','2014-09-02 05:21:25',1,2),(6,'busccccc','123456','5260','busssss','busssssss','0000-00-00 00:00:00',1,2),(7,'van',NULL,NULL,'van','van','0000-00-00 00:00:00',1,2),(10,'1','1','6668','1','1','2014-09-07 14:51:46',2,2),(11,'a','123123','5303','a','a','2014-09-09 13:08:39',1,2),(12,'a','123','8896','123','a','2014-09-09 13:09:06',1,2),(13,'','','5706','','','2014-09-09 13:10:03',1,2);
...
-- Dump completed on 2014-09-10  2:49:11
