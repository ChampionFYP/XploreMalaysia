...
<html>
  ...
  <?php 
    ...
    { ?>
  <h2 style="color:#66a9bd;text-align:left; margin-left:80px; font-size:40px;"><b><?php  echo $row['accomodation_name']; ?></b></h2>
  <table id="travel">
    <thead>    
        <tr>
        ...
        <td style="border-left:0;">
          <img src="http://admin.xploremalaysia.asia/photo/accomodation/<?php echo $row1['accomodation_image_id'];?>"  style="float:right; margin-left:10px;" height="300px" width="450px" >
        </td>
        <tr>
          <td colspan="2">
            <a class="btn btn-info pull-left" href="http://xploremalaysia.asia/accomodation.php">Back</a>
          </td>
    </thead>
  </table>
  </form>
