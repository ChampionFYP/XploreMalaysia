  ...
  <table id="travel">
    <thead>    
        ...
        <td style="border-left:0;">
          <img src="http://admin.xploremalaysia.asia/photo/accomodation/<?php echo $row['accomodation_image_id'];?>"  style="float:right; margin-left:10px;" height="300px" width="450px" >
        </td>
        <tr>
          <td colspan="2">
