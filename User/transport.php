              ...
              { ?>             
                          <div class="owl-item">
                            <div style=""class="item">
                               <div class="box1">
                                    <div class="title2"><?php  echo $row1['transport_name']; ?> <em><?php  echo $row1['package_name']; ?></em></div>
                                    ...
                                    <button name="view_btn"  value="<?php  echo $row1['transport_id']; ?>" class="title5">View now!</button>
                               </div>
                           </div>
                         </div>
            <?php } ?>
