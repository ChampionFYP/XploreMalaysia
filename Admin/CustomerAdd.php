    ...
    <button class="btn btn-default" type="submit">submit</button>
        ...
        <div id="tab-general">
          ...
          <div id="tab-customer" class="vtabs-content">
            ...
            <table class="form">
              <tr>
                ...
                <td><input class="inputbox" id="username" type="text" name="username" placeholder="First">
                  </td>
              </tr>
          <tr>
          ...
          <tr>
            ...
            <td><p class="inputbox"><input type="radio" name="gender" value="1">Male
                          <input type="radio" name="gender" value="2">Female </p></td>
          </tr>
              <tr>
