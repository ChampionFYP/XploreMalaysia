      				 	...
      				 	<?php 
							...
							{ ?>
							    <tr>
							    	...
							    	<td>
							    	<img src="http://<?php echo $_SERVER['SERVER_NAME'] . "/photo/package/". $row['package_image_id'];?>" alt="" height="42" width="42">	
							    	</td>
							    	<td class="center">  <?php  echo $row['number_person']; ?></td>
							    	<td class="center">  <?php  echo $row['country_name']; ?></td>
							    	<td class="center">  <?php  echo $row['transport_name']; ?></td>
