	...
	<div class="fluid-container">
		...
		<div class="row">
			...
			<div class="box col-sm-12 col-md-10 pull-right">
				<div class="heading">
					<h1>Booking</h1>
					<div class="btn btn-default">Print Invoice</div>
        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="right">                <a href="" class="desc">Booking ID</a>
                </td>
              <td class="left">                <a href="">Customer</a>
                </td>
				<td class="left">                <a href="">No. of Person</a>
                </td>
              <td class="left">                <a href="">Status</a>
                </td>
              <td class="right">                <a href="">Total</a>
                </td>
